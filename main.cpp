...
void render_conan_logo() {
	...
	ImGui::DragFloat("Size", &sz, 0.2f, 2.0f, 720.0f, "%.0f");
	ImGui::ColorEdit4("Color1", &col1.x);
	ImGui::ColorEdit4("Color2", &col2.x);
	ImGui::ColorEdit4("Color3", &col3.x);
	ImGui::ColorEdit4("Color4", &col4.x);
	const ImVec2 p = ImGui::GetCursorScreenPos();
	const ImU32 col32_1 = ImColor(col1);
	const ImU32 col32_2 = ImColor(col2);
	const ImU32 col32_3 = ImColor(col3);
	const ImU32 col32_4 = ImColor(col4);
...
void create_triangle(unsigned int& vbo, unsigned int& vao, unsigned int& ebo) {
	...
	float triangle_vertices[] = {
		...
		0.25f, -0.5f, 0.0f,  // position vertex 1
